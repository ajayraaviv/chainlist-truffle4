...
contract('ChainList', function(accounts) {
  ...
  it("should let us sell a first article", function () {
      return ChainList.deployed().then(function(instance) {
        ...
        assert.equal(data[4], articleDescription1, "event article name must be " + articleDescription1);
  ...
  it("should let us sell a second article", function () {
      return ChainList.deployed().then(function(instance) {
        ...
        assert.equal(data[4], articleDescription2, "event article name must be " + articleDescription2);
...
it("should buy an article", function() {
  return ChainList.deployed().then(function(instance) {
    ...
    assert.equal(data.length, 1, "there should be only one article left for sale");
    assert.equal(data[0].toNumber(), 2, "article 2 should be the only articleleft for sale");
    return chainListInstance.getNumberOfArticles();
  }).then(function(data) {
